      ...
      {auth ? (
        <div className="p-8 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <h1 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
            You&apos;re already signed in. <br />
            Want to logout?
          </h1>
          <button
            onClick={handleLogOut}
            className="px-6 cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 disabled:bg-opacity-70 disabled:cursor-not-allowed"
          >
            Log Out
          </button>
        </div>
              ...
              <div className="hidden w-full xl:block xl:w-1/2">
                <div className="py-17.5 px-26 text-center">
                  ...
                  <p className="2xl:px-20">
                    Enter your username and password to signin to your account.
                  </p>
